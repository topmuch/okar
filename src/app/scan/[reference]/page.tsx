...
import UnifiedTimeline from '@/components/maintenance/UnifiedTimeline';
...
export default function VehicleScanPage() {
  ...
  const [activeTab, setActiveTab] = useState<'history' | 'unified'>('unified');
