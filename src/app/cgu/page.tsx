...
export const metadata: Metadata = {
  ...
  description: 'CGU de OKAR - Conditions d\'utilisation de nos services de protection des bagages.',
};
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-8 text-[#e0e6f0]">
            <section>
              ...
              <p className="mb-4">
                Les présentes Conditions Générales d&apos;Utilisation (CGU) ont pour objet de définir les modalités et conditions d&apos;utilisation des services proposés par OKAR, ainsi que de définir les droits et obligations des parties dans ce cadre.
              </p>
              <p>
                En utilisant les services OKAR, vous acceptez sans réserve les présentes CGU. Si vous n&apos;acceptez pas ces conditions, veuillez ne pas utiliser nos services.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="mb-4">
                OKAR propose un service de protection des bagages basé sur la technologie QR Code. Les services incluent :
              </p>
            ...
            <section>
              ...
              <p>
                OKAR se réserve le droit de suspendre ou supprimer un compte en cas de non-respect des présentes CGU.
              </p>
            </section>
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-2 mb-4">
                ...
                <li>Respecter les droits de propriété intellectuelle de OKAR</li>
                <li>Signaler tout contenu ou comportement inapproprié</li>
              </ul>
              <p>
                L&apos;utilisation des services OKAR à des fins frauduleuses ou malveillantes est strictement interdite et pourra faire l&apos;objet de poursuites judiciaires.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="mb-4">
                Chaque autocollant OKAR comporte un QR Code unique qui doit être activé pour être fonctionnel. Les conditions d&apos;activation sont les suivantes :
              </p>
              <ul className="list-disc pl-6 space-y-2 mb-4">
                <li>L&apos;activation se fait via le site web OKAR en scannant le QR Code ou en saisissant la référence</li>
            ...
            <section>
              ...
              <p className="mb-4">
                En cas de perte ou de trouvaille d&apos;un bagage équipé d&apos;un QR Code OKAR :
              </p>
              <ul className="list-disc pl-6 space-y-2 mb-4">
                ...
                <li>OKAR facilite la mise en relation mais n&apos;assure pas le transport du bagage</li>
                <li>Les informations personnelles restent protégées jusqu&apos;à consentement explicite</li>
              </ul>
              <p>
                OKAR ne peut être tenu responsable en cas d&apos;impossibilité de restitution du bagage.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="mb-4">
                Les tarifs des services OKAR sont affichés sur le site et peuvent être modifiés à tout moment. Les conditions de paiement sont les suivantes :
              </p>
              <ul className="list-disc pl-6 space-y-2">
            ...
            <section>
              ...
              <p className="mb-4">
                OKAR s&apos;engage à mettre en œuvre tous les moyens nécessaires pour assurer le bon fonctionnement de ses services. Toutefois, OKAR ne pourra être tenu responsable :
              </p>
              <ul className="list-disc pl-6 space-y-2 mb-4">
              ...
              <p>
                La responsabilité de OKAR est limitée au montant des sommes versées par l&apos;utilisateur.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="mb-4">
                L&apos;ensemble des éléments constituant le site OKAR (textes, images, logos, icônes, logiciels, QR Codes, etc.) est protégé par le droit de la propriété intellectuelle.
              </p>
              <p>
            ...
            <section>
              ...
              <p className="mb-4">
                Les données personnelles collectées par OKAR sont traitées conformément à notre <a href="/confidentialite" className="text-[#b8860b] hover:underline">Politique de confidentialité</a> et dans le respect du Règlement Général sur la Protection des Données (RGPD).
              </p>
              <p>
                Pour toute question relative à vos données personnelles, contactez-nous à : contact@okar.com
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                OKAR se réserve le droit de modifier les présentes CGU à tout moment. Les utilisateurs seront informés de toute modification substantielle par notification sur le site ou par email. L&apos;utilisation continue des services après modification vaut acceptation des nouvelles CGU.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                <strong>Email :</strong> <a href="mailto:contact@okar.com" className="text-[#b8860b] hover:underline">contact@okar.com</a><br />
