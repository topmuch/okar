...
const adminFeatures = [
  ...
  { icon: "⚙️", title: "Intégrations API", desc: "Gérez garages, véhicules, et statistiques" },
  { icon: "👥", title: "Gestion des rôles", desc: "Garages, conducteurs, administrateurs — tout contrôlé" }
];
            ...
            <div className="w-full h-80 rounded-2xl bg-gradient-to-br from-emerald-900 to-slate-900 flex items-center justify-center overflow-hidden">
              <div className="text-center p-6">
                ...
                <p className="text-slate-300 max-w-sm text-lg">
                  Gérez garages, véhicules, utilisateurs, API — tout depuis un seul tableau de bord.
                </p>
              </div>
            </div>
        ...
        <div className="w-full max-w-md">
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-slate-600 dark:text-slate-400">
              Vous êtes un garage ?{' '}
              <Link href="/garage/connexion" className="font-medium text-amber-500 hover:text-amber-600">
                Connexion Garage
              </Link>
            </p>
          </div>
