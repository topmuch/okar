...
export const metadata: Metadata = {
  ...
  description: 'Politique de confidentialité de OKAR - Comment nous protégeons vos données personnelles.',
};
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-8 text-[#e0e6f0]">
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-2">
                <li>Gestion et suivi des bagages enregistrés via le système OKAR</li>
            ...
            <section>
              ...
              <p>
                Pour exercer ces droits, contactez-nous à : <a href="mailto:contact@okar.com" className="text-[#b8860b] hover:underline">contact@okar.com</a>
              </p>
            </section>
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-2">
                <li>Nos partenaires de livraison pour l&apos;expédition des autocollants OKAR</li>
