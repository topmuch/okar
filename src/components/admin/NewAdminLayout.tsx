...
export default function AdminLayout({ children, title, subtitle, unreadMessages = 0 }: AdminLayoutProps) {
  ...
  const menuItems: MenuItem[] = [
    ...
    { label: "Garages", icon: <Building className="w-5 h-5" />, href: "/admin/garages" },
    { label: "PRODUITS", icon: null, isCategory: true },
    { label: "Générer QR", icon: <QrCode className="w-5 h-5" />, href: "/admin/generer" },
    { label: "QR Codes", icon: <QrCode className="w-5 h-5" />, href: "/admin/qrcodes" },
    { label: "VÉHICULES", icon: null, isCategory: true },
    { label: "Tous les véhicules", icon: <Car className="w-5 h-5" />, href: "/admin/vehicles" },
